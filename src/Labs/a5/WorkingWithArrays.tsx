...
function WorkingWithArrays() {
  ...
  return (
      <div>
        ...
        <a className="btn btn-success m-2" href={API}>
          Get Todos
        </a>
        ...
        <a className="btn btn-success m-2" href={`${API}/${todo.id}`}>
          Get Todo by ID
        </a>
        <h3>Filtering Array Items</h3>
        <a className="btn btn-success m-2" href={`${API}?completed=true`}>
          Get Completed Todos
        </a>
        ...
        <a className="btn btn-success m-2" href={`${API}/${todo.id}/delete`}>
        ...
        <a className="btn btn-success m-2" href={`${API}/${todo.id}/title/${todo.title}`}>
          Update Title
        </a>
        <br/>
        ...
        <a className="btn btn-success m-2" href={`${API}/${todo.id}/completed/${todo.completed}`}>
          Update Completed
        </a>
        <br/>
